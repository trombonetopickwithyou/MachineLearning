...
layers = [
    ...
    convolution2dLayer(10,128,'Padding','same','Stride',[3 3])
    batchNormalizationLayer
    reluLayer
    
    averagePooling2dLayer(2,'Stride',2)
    
    convolution2dLayer(5,256,'Padding',0)
    batchNormalizationLayer
    reluLayer
    
    averagePooling2dLayer(2,'Stride',2)
    
    convolution2dLayer(4,512,'Padding',0)
    batchNormalizationLayer
    tanhLayer
    
    maxPooling2dLayer(2,'Stride',2)
    
    convolution2dLayer(3,1024,'Padding',0)
    batchNormalizationLayer
    tanhLayer
